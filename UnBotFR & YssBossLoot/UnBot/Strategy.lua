...
local function CreateStrategyFrame(name)
	...
	strategyFrame.title:SetText("|cff00ffff"..name.."|r".." - Éditeur de stratégies");
	...
	strategyFrame.leftText:SetText("Stratégies de combat");
	...
	strategyFrame.rightText:SetText("Stratégies hors combat");
